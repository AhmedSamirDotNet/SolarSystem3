...
namespace SolarSystem.DataAccess1.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "MainDesc", "Name", "Price", "SectionId", "SubDesc" },
                values: new object[,]
                {
                    { 1, "High efficiency panel", "Super Solar 3000", 500.00m, 1, null },
                    { 2, "Pure sine wave inverter", "MaxVolt Inverter", 1200.00m, 2, null }
                });
